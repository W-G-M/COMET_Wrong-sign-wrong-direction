...
for file in lustre/user/gmwong/basic_studies-master-CyDetWrongSign/CyDetWrongSign/SimG4CyDet/PartGunElecFromDisk/workdir_positron/Job_positron_"$i"/; do

cd /lustre/user/gmwong/basic_studies-master-CyDetWrongSign/CyDetWrongSign/SimG4CyDet/PartGunElecFromDisk/workdir_positron/Job_positron_"$i"/

cp -r  oa_g4_ep_00000000-00"$i"_*.root  /lustre/user/gmwong/basic_studies-master-CyDetWrongSign/CyDetWrongSign/SimG4CyDet/PartGunElecFromDisk/workdir_positron
...
ls /lustre/user/gmwong/basic_studies-master-CyDetWrongSign/CyDetWrongSign/SimG4CyDet/PartGunElecFromDisk/workdir_positron/oa*.root > samplelistPositron.txt